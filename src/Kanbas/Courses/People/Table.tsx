      ...
      <table className="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="wd-total-activity">10:40:32</td>
          </tr>
          <tr>
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
          ...
          <tr>
            <td className="wd-full-name text-nowrap">
              ...
              <span className="wd-last-name">Deo</span>
            </td>
            <td className="wd-login-id">001234565S</td>
            <td className="wd-section">S101</td>
            <td className="wd-role">TA</td>
            <td className="wd-last-activity">2020-11-04</td>
            <td className="wd-total-activity">12:54:32</td>
          </tr>
          <tr>
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
              <span className="wd-first-name">Stan</span>{" "}
              <span className="wd-last-name">Jobs</span>
            </td>
            <td className="wd-login-id">001234566S</td>
            <td className="wd-section">S101</td>
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2021-10-04</td>
            <td className="wd-total-activity">05:21:32</td>
          </tr>
          <tr>
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
              <span className="wd-first-name">John</span>{" "}
              <span className="wd-last-name">Harley</span>
            </td>
            <td className="wd-login-id">001234567S</td>
            <td className="wd-section">S101</td>
            <td className="wd-role">TA</td>
            <td className="wd-last-activity">2021-11-05</td>
            <td className="wd-total-activity">05:09:34</td>
          </tr>
          <tr>
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
              <span className="wd-first-name">Ketie</span>{" "}
              <span className="wd-last-name">Wayne</span>
            </td>
            <td className="wd-login-id">001234568S</td>
            <td className="wd-section">S101</td>
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2021-10-08</td>
            <td className="wd-total-activity">15:08:44</td>
          </tr>
        </tbody>
      </table>
    </div>
