  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        My favorite recipe:
        <ol id="wd-chicken-curry">
          <li>Cook chicken in pressure cooker</li>
          <li>Add oil, onion and spices in vessel</li>
          <li>Add water and chicken in it</li>
          <li>Serve!</li>
        </ol>
      ...
      <div id="wd-forms">
        ...
        <form id="wd-text-fields">
          ...
          />
          <br />
          <label htmlFor="wd-text-fields-state">State:</label>
          <input
            type="text"
            id="wd-text-fields-state"
            title="MA"
            placeholder="MA"
          />
          <br />
          <label htmlFor="wd-text-fields-country">Country:</label>
          <input
            type="text"
            id="wd-text-fields-country"
            title="USA"
            value="USA"
          />
      ...
      <textarea id="wd-textarea" cols={30} rows={10}>
        ...
        officiis ipsam dolor amet in. Hic dolor, magnam nobis pariatur alias
        officiis porro, aperiam ipsam non dolore itaque? Error, maxime quisquam.
      </textarea>
